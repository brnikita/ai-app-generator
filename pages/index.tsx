...
const Home: NextPage = () => {
  ...
  const handleGenerate = async () => {
    if (!description.trim()) {
      setError('Please provide a description for your web application');
      return;
    }
    ...
    try {
      ...
      setError('Failed to generate project configuration');
    } finally {
      ...
      <header className="pt-16 pb-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-200 max-w-2xl mx-auto">
            ...
            Create a custom web application powered by AI. Just describe what you need, and we'll generate a complete application.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-blue-300/10">
            ...
            <p className="text-blue-200/80">Advanced AI understands your needs and generates tailored solutions</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-blue-300/10">
            ...
            <p className="text-blue-200/80">Built with Next.js, TypeScript, and enterprise-grade technologies</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm p-6 rounded-xl border border-blue-300/10">
            ...
            <p className="text-blue-200/80">Includes testing, documentation, and deployment configurations</p>
          </div>
        </div>
      </main>
